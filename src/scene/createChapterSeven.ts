  ...
  const createFamilyPictureMaterial = (subject: 'baby' | 'swing'): MeshStandardMaterial => {
    ...
    if (context) {
      ...
      if (subject === 'baby') {
        ...
        context.beginPath();
        context.ellipse(118, 108, 68, 34, -0.08, 0, Math.PI * 2);
        context.fill();
        context.fillStyle = '#5f9fe7';
        context.beginPath();
        context.ellipse(119, 108, 54, 25, -0.08, 0, Math.PI * 2);
        context.fill();
        context.fillStyle = 'rgba(255, 255, 255, 0.62)';
        context.beginPath();
        context.ellipse(104, 98, 24, 8, -0.08, 0, Math.PI * 2);
        context.fill();
